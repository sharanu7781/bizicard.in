...
<html lang="en">
  <head>
        ...
        <style>.header_div{background-color:'.$content_background_color.';color:'.$content_font_color.'}.modal_setting_class{background-color: '.$modal_menu_background_color.'!important;color:'.$modal_menu_font_color.'!important;height: 40px !important;align-items: center !important;display: flex !important;justify-content: center !important;}a{color:'.$modal_menu_font_color.'!important;}/*.image_custome_style{width:400px !important;height:300px !important}*/.slider_image_style{width:500px !important;height:300px !important}#slider_section{/*width:500px;height:300px;padding-bottom:10px; padding-top:10px*/}.photo{border-radius:50%;margin-top:0px !important;width:100px;height:100px}.company_logo{padding-top:5px;}.sidebar-box {max-height: 100px;position: relative;overflow: hidden;}.sidebar-box .read-more { position: absolute; bottom: 0; left: 0;width: 100%; text-align: center;margin: 0; background-image: linear-gradient(to bottom, transparent, '.$content_background_color.');}.read_more_button{font-weight:bold;font-size:16px;color:#fff;background-color:#8B8888 !important;}.pdes{padding-bottom:8px !important;}.profile_pic_row,.company_logo_row{padding-top:5px !important;padding-bottom:5px !important;}</style>
        <style>.required{color:red}.btn_share{background-color:'.$contact_background_color.';border-color:'.$contact_background_color.'}.btn_share:hover{background-color:'.$contact_background_color.';border-color:'.$contact_background_color.'}</style>
  ...
  <body>
              ...
              <div class="row icon-row">
                    ...
                    <!-- </div> -->
                      <div class="col mini-box">                
                        <a href="https://api.whatsapp.com/send?phone='.$whatsapp_number.'&amp;text=Got%20reference%20from%20your%20Digital%20vCard.%20Want%20to%20know%20more%20about%20your%20products%20and%20services."><img src="'.base_url().'custome_premium_template/template/img/new-whatsapp.png" class="icon" alt="WhatsApp"></a>
                         ...
                         <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">WhatsApp</p>
                      </div>';
                      if (!empty($postdata_array['qr_page_link'])) {
                        $dynamic_index_html .= '
                        <div class="col mini-box">
                            <a href="'.stripslashes($postdata_array['qr_page_link']).'" target="_blank"><img src="'.base_url().'custome_premium_template/template/img/new-scan.png" class="icon" alt="Qr code"></a>
                            <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">QR Code</p>
                        </div>';
                        }
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Call</p>
                      </div>
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Email</p>
                    ...
                    if(!empty($postdata_array['facebook_page_link']))
                      ...
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Facebook</p>
                      </div>';
                    else
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                    ...
                    if(!empty($postdata_array['instagram_page_link']))  
                      ...
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Instagram</p>
                      </div>';
                    else
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                    ...
                    if(!empty($postdata_array['linkedin_page_link']))  
                      ...
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Linkedin</p>
                      </div>';
                    else
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                    ...
                    if(!empty($postdata_array['twitter_page_link']))  
                      ...
                      <div class="col mini-box">
                        <a href="'.$postdata_array['twitter_page_link'].'" target="_blank"><img src="'.base_url().'custome_premium_template/template/img/new-twitter.png" class="icon" alt="Twitter"></a>
                         <p class="icon-name" style="text-align: center; margin-top: 5px;color: ' . $contact_font_color . ';">Twitter</p>
                      </div>';
                    else
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                    ...
                    if(!empty($postdata_array['youtube_page_link']))  
                      $dynamic_index_html .= '
                        <div class="col mini-box">
                          ...
                          <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">Youtube</p>
                        </div>';
                    else
                      $dynamic_index_html .= '
                        <div class="col mini-box">
                    ...
                    if(!empty($website_url))                
                      ...
                      <div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">Website</p>
                      </div>';
                    else
                      $dynamic_index_html .= '
                      <div class="col mini-box">
                    ...
                    $dynamic_index_html .= '<div class="col mini-box">
                        ...
                        <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">Save Contact</p>
                      </div>';
                    ...
                    if(!empty($postdata_array['gmap_pin_url']))
                      $dynamic_index_html .= '
                        <div class="col mini-box">
                          ...
                          <p class="icon-name" style="text-align: center; margin-top: 5px; color: ' . $contact_font_color . ';">G-Map</p>
                        </div>';
                    else
                      $dynamic_index_html .= '
                        <div class="col mini-box">
                          <a href="javascript:void(0)"><img src="'.base_url().'custome_premium_template/template/img/map-disable.png" class="icon" alt="Maps"></a>
                          <p class="icon-name" style="text-align: center; margin-top: 5px;">G-Map</p>
                        </div>';
                ...
                foreach($input_counter as $row) {
                  ...
                  if(!empty($accordian_label) && !empty($accordian_content) && $postdata_array['menus_opened_as'] == "Accordian") { 
                    ...
                    $dynamic_index_html .= '<div id="accordion">
                                              <div class="card mb-1 shadow-none accordian_div_'.$accordian_id_array[$i-1].'">
                    ...
                    // Set default color and background-color for all <a> tags
                    $styled_accordian_content = str_replace(
                        ['<a ', '<a style="color: blue;" '],
                        ['<a style="color: blue; background-color: #3598db;" ', '<a style="color: blue; background-color: #3598db;" '],
                        $accordian_content
                    );
                
                    $dynamic_index_html .= '
                    <p class="modal_setting_class accordian_div_'.$accordian_id_array[$i-1].'">
                        <a data-toggle="modal" data-target="#modal_menu_'.$i.'" href="javascript:void(0)">'.$accordian_label.'</a>
                    </p>
                
                    <!-- Modal -->
                    <div aria-hidden="true" aria-labelledby="modal_menu_'.$i.'" class="modal fade accordian_div_'.$accordian_id_array[$i-1].'" id="modal_menu_'.$i.'" role="dialog" tabindex="-1">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modal_menu_'.$i.'">'.$accordian_label.'</h5>
                                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                                </div>
                                <div class="modal-body">
                                    <p>'.$styled_accordian_content.'</p>
                                </div>
                            </div>
                        </div>
                    </div>';
    ...
    <script>
      $(document).ready(function(){ 
        ...
        // Check from here if users accordian data, means Pages have been removed or not, if they deleted then hide that div from HTML display on card
        $.ajax({
          url:"'.base_url().'digital_card/get_accordian_information",
          type:"POST",  
          data:{username:"'.$postdata_array["name"].'"},
          success:function(data){
            if($.trim(data)!="") {
                data = $.trim(data);
                var split_pages = data.split("###");
                for (var i = 0; i < split_pages.length; i++) {
                    var pages = split_pages[i].split("#");
                    if(pages[1]=="Y")
                        $(".accordian_div_"+pages[0]).remove();
                }
            } else {
