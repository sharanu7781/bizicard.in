...
">Processing...</span>
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                ...
                $('#upload_image_1').change(function(event){
                    ...
                    if ((file = this.files[0])) {
                        ...
                        img.onload = function() {                           
                            ...
                            //     alert("Please select image more than 500x350px");
                        ...
                        $('#uploaded_image_1').attr('src', img.src);
            ...
            $(document).ready(function(){
                ...
                $('#upload_image_2').change(function(event){
                    ...
                    if ((file = this.files[0])) {
                        ...
                        img.src = _URL.createObjectURL(file);
                        $('#uploaded_image_2').attr('src', img.src);
                    }                    
                });
            ...
            $(document).ready(function(){
                ...
                $('#upload_image_3').change(function(event){
                    ...
                    if ((file = this.files[0])) {
                        ...
                        img.src = _URL.createObjectURL(file);
                        $('#uploaded_image_3').attr('src', img.src);
                    }                    
                });
            ...
            //Get cropping tool ready for Slider 4 section
            $(document).ready(function(){
                //profile image cropping
                var $modal = $('#modal_4');
                ...
                $('#upload_image_4').change(function(event){
                    ...
                    if ((file = this.files[0])) {
                        ...
                        img.src = _URL.createObjectURL(file);
                        $('#uploaded_image_4').attr('src', img.src);
            ...
            //Get cropping tool ready for Slider 5 section
            $(document).ready(function(){
                //profile image cropping
                var $modal = $('#modal_5');
                ...
                $('#upload_image_5').change(function(event){
                    ...
                    if ((file = this.files[0])) {
                        ...
                        img.src = _URL.createObjectURL(file);
                        $('#uploaded_image_5').attr('src', img.src);
