          ...
          $dynamic_index_html .= '
            ...
            <div class="col">
              <div class="row icon-row">
                ...
                $dynamic_index_html .= '
                <div class="col col-md-2">
                  <a href="tel:'.stripslashes($postdata_array['whatsapp_number']).'" target="_blank"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-call.png" class="icon" alt="Call me"></a>
                </div>';

                if(!empty($postdata_array['whatsapp_number']))
                $dynamic_index_html .= '<div class="col col-md-2">                
                  <a href="https://api.whatsapp.com/send?phone='.stripslashes($postdata_array['whatsapp_number']).'&amp;text=Got%20reference%20from%20your%20Digital%20vCard.%20Want%20to%20know%20more%20about%20your%20products%20and%20services."><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-whatsapp.png" class="icon" alt="WhatsApp"></a>
                </div>';

                $dynamic_index_html .= '<div class="col col-md-2">
                    <a href="'.base_url().'vcf_files/'.stripslashes($postdata_array["name"]).'.vcf"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-save.png" class="icon" alt="WhatsApp"></a>
                  </div>';

                $dynamic_index_html .= '
                  <div class="col col-md-2">
                    <a href="mailto:'.stripslashes($postdata_array['email_id']).'" target="_blank"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-email.png" class="icon" alt="WhatsApp"></a>
                  </div>';
                  $dynamic_index_html .= '
                  <div class="col col-md-2">
                  </div>
            ...
            if(!empty($postdata_array['website_url']))
              ...
              $dynamic_index_html .= '
              <div class="col col-md-2">
                <a target="_blank" href="'.$website_url.'"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-website.png" class="icon" alt="WhatsApp"></a>
              </div>';
            
              if(!empty($postdata_array['facebook_page_link']))
                $dynamic_index_html .= '<div class="col col-md-2">
                    <a target="_blank" href="'.stripslashes($postdata_array['facebook_page_link']).'"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-facebook.png" class="icon" alt="WhatsApp"></a>
                  </div>';
              else 
                $dynamic_index_html .= '<div class="col col-md-2">
                    <a href="javascript:void(0)"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/disable-facebook.png" class="icon" alt="WhatsApp"></a>
                  </div>';
              if(!empty($postdata_array['instagram_page_link']))
                  $dynamic_index_html .= '<div class="col col-md-2">
                                      <a target="_blank" href="'.stripslashes($postdata_array['instagram_page_link']).'"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-insta.png" class="icon" alt="WhatsApp"></a>
                                    </div>';
              else 
                  $dynamic_index_html .= '<div class="col col-md-2">
                  <a  href="javascript:void(0)"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/disable-insta.png" class="icon" alt="WhatsApp"></a>
                </div>';

              if(!empty($postdata_array['linkedin_page_link']))
                  $dynamic_index_html .= '<div class="col col-md-2">
                          <a target="_blank" href="'.stripslashes($postdata_array['linkedin_page_link']).'"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-linkedin.png" class="icon" alt="WhatsApp"></a>
                        </div>';   
              else
                  $dynamic_index_html .= '<div class="col col-md-2">
                  <a href="javascript:void(0)"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/disable-linkedin.png" class="icon" alt="WhatsApp"></a>
                </div>';   
                $dynamic_index_html .= '
            ...
            if(isset($postdata_array['input_counter']) && !empty($postdata_array['input_counter'])) {
              ...
              if(!empty($input_counter) && count($input_counter) > 0) {
                if(isset($postdata_array['menus_opened_as']) && $postdata_array['menus_opened_as'] !='' && $postdata_array['menus_opened_as']=="Accordian") {
            ...
            if(!empty($postdata_array['gmap_pin_url']))
              $dynamic_index_html .= '<div class="col col-centered-flex align-items-center justify-content-center footer">
                  <a href="'.$postdata_array['gmap_pin_url'].'"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/enable-map.png" class="icon" alt="WhatsApp"></a>
                </div>';
            else
              $dynamic_index_html .= '<div class="col col-centered-flex align-items-center justify-content-center footer">
                  <a href="javascript:void(0)"><img src="'.base_url().'sample_template/public/assets/images/social_media_icons/disable-map.png" class="icon" alt="WhatsApp"></a>
                </div>';
