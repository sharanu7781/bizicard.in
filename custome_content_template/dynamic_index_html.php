...
<html lang="en">
  <head>
        ...
        <style>
          ...
          margin: 0; background-image: linear-gradient(to bottom, transparent, '.$content_background_color.');}.read_more_button{font-weight:bold;font-size:16px;color:#fff;background-color:#8B8888 !important;}.pdes{padding-bottom:8px !important;}.profile_pic_row,.company_logo_row{padding-top:5px !important;padding-bottom:5px !important;}.btn_share{background-color:'.$contact_background_color.';border-color:'.$contact_background_color.'}.btn_share:hover{background-color:'.$contact_background_color.';border-color:'.$contact_background_color.'}</style>
